        ...
        if (new_input != 1){
            ...
            case 'V':
                ...
                if (S_dist.numVertices < 2) {
                    std::cout << "Error: Vertices should be more than 1"<<std::endl;
                    break;
                }
                previous = 'V';
                break;
            ...
            case 'E':
                if (previous == 'V') {
                    ...
                    if (ret != 0){
                        std::cout<<"Error: Incorrect Edges"<<std::endl;
                    }
                    previous = 'E';
                    break;
                }else if (previous == 'E') {
                ...
                std::cout<<"Error: Vetex is not received"<<std::endl;
                break;
            
            case 's':
                if (previous == 'E' and ret != 0){
                    std::cout<<"Error: Given edge is incorrect"<<std::endl;
                    break;
                }
                if (previous == 'E') {
                    command >> start;
                    ...
                    if (start > S_dist.numVertices || start < 1 || end > S_dist.numVertices || end < 1){
                        std::cout<<"Error: Incorrect Vertices"<<std::endl;
                        break;
                    }
                ...
                std::cout<<"Error: Vetex or Edge not received"<<std::endl;
                break;
